...
public class Activity_PerfilUsuario extends AppCompatActivity {
    ...
    private void actualizarInformacionUsuario() {
        String url = "https://phpclusters-152621-0.cloudclusters.net/mostrarUsuarioPerfil.php?id="+IdPersonal+"&idUsuarioSeguido="+IdUsuario+"";
    ...
    private void crearSeguidor(int idUsuarioSeguidor, String Info) {
        ...
        if("solicitud".equals(Info)){
            urlCrearSeguidor = "https://phpclusters-152621-0.cloudclusters.net/confirmarSolicitudSeguidor.php?idUsuarioSeguido=" + IdPersonal +"&idUsuario="+idUsuarioSeguidor;
        }else {
            urlCrearSeguidor = "https://phpclusters-152621-0.cloudclusters.net/crearSeguidor.php?idUsuarioSeguido=" + idUsuarioSeguidor +"&idUsuario="+IdPersonal+"";
        }
